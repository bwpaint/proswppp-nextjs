...
// Fonts are loaded via Google Fonts <link> on the live site (rollback per
// owner direction). /home-3/ overrides with self-hosted next/font via
// its own scoped layout at src/app/home-3/layout.tsx — works because
// globals.css uses "font-family: var(--font-inter), 'Inter', ...": when
// the variable is undefined (live), the 'Inter' fallback resolves to
// the <link>-loaded font; when defined (/home-3/), it resolves to
// next/font's self-hosted variant.
