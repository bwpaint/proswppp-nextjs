...
export const metadata: Metadata = {
  title: 'Locations | Pro SWPPP',
  description: 'Pro SWPPP serves construction projects across the United States. Find your state and get a fully compliant SWPPP in 72 hours.',
};
